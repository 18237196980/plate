...
/***/ 20:
/*!******************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/common/api.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 密码登陆
function loginByPwd(user) {
  var url = "/plate/user/loginByPwd";
  return net.post(url, user);
}

// 注册
function register(params) {
  var url = "/plate/user/register";
  return net.post(url, params);
}

// 微信登陆
function loginWeiXin(params) {
  var url = "/plate/user/loginWeiXin";
  return net.post(url, params);
}

// token登陆
function loginByToken() {
  var url = "/plate/user/loginByToken";
  return net.post(url);
}

// 退出登陆
function logout(uid) {
  var url = "/plate/user/logout?uid=".concat(uid);
  return net.post(url);
}
...
function updatePwd(params) {
  var url = "/plate/me/updatePwd";
  return net.post(url, params);
}

// 修改头像
function changeHeader(params) {
  var url = "/plate/me/changeHeader";
  return net.post(url, params);
}

// 完善个人资料
function fullUserInfo(params) {
  var url = "/plate/me/fullUserInfo";
  return net.post(url, params);
}

// 发送验证码
function getPhoneCode(phone, code_flag) {
  var url = "/plate/me/getPhoneCode?phone=".concat(phone, "&code_flag=").concat(code_flag);
  return net.post(url);
}

// 手机号验证码登陆
function loginByPhone(phone, code) {
  var url = "/plate/user/loginByPhone?phone=".concat(phone, "&code=").concat(code);
  return net.post(url);
}
...
// 车牌列表
function plateList(pageNumber, pageSize, searchParam) {
  var url = "/plate/main/list?pageNumber=".concat(pageNumber, "&pageSize=").concat(pageSize, "&searchParam=").concat(searchParam);
  return net.post(url);
}

// 添加车牌
function addPlate(model) {
  var url = "/plate/main/add";
  return net.post(url, model);
}

// 修改车牌
function editPlate(model) {
  var url = "/plate/main/edit";
  return net.post(url, model);
}

// 删除车牌
function del(id) {
  var url = "/plate/main/del?id=".concat(id);
  return net.post(url);
}

// 车牌详情
function initPlate(id) {
  var url = "/plate/main/initPlate?id=".concat(id);
  return net.get(url);
}
...
/***/ 21:
/*!******************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/common/net.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var auth = __webpack_require__(/*! ./auth.js */ 22);
var config = __webpack_require__(/*! ../config.js */ 23);

/**
                                       * 封装微信的的request
                                       */
function request(code) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "GET";
  return new Promise(function (resolve, reject) {
    uni.request({
      url: config.URL + code,
      data: data,
...
function get(code) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return request(code, data, 'GET');
}

function post(code) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
/***/ 22:
/*!*******************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/common/auth.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 23:
/*!**************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/config.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 24:
/*!*******************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/common/util.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function showToast(title) {var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "none";var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2000;
  uni.showToast({
    title: title,
    icon: icon,
    duration: duration });
...
/***/ 4:
/*!***************************************************!*\
  !*** D:/mywork/code/uni-ui-demo/plate/pages.json ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
